    ...
    <>
      ...
      <section className="relative h-screen bg-cover bg-center pt-16">
        ...
        <div className="absolute inset-0 z-0">
          ...
          <img src="/api/placeholder/1920/1080" alt="Mountain Background" className="w-full h-full object-cover" />
        </div>
        
        <div className="relative z-10 h-full flex flex-col justify-center items-center text-white text-center px-4">
          <img src="/api/placeholder/120/60" alt="Berkelana Logo" className="mb-16" />
          ...
          <div className="bg-white/90 rounded-lg p-6 w-full max-w-5xl">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              <div className="flex flex-col md:col-span-3">
                ...
                <select className="w-full border border-gray-200 p-3 rounded text-gray-800 appearance-none bg-white">
              ...
              <div className="flex flex-col md:col-span-2">
                ...
                <div className="relative">
                  <input 
                    ...
                    className="w-full border border-gray-200 p-3 rounded text-gray-800 appearance-none"
                  />
          ...
          <div className="flex flex-col md:flex-row items-center md:items-start">
            ...
            <div className="md:w-2/3 grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="bg-purple-100 rounded-lg p-6 flex">
                <div className="mr-4">
                  <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center">
                    <img src="/api/placeholder/40/40" alt="Wallet" className="w-10 h-10" />
                  </div>
                </div>
                <div>
              ...
              <div className="bg-purple-100 rounded-lg p-6 flex">
                <div className="mr-4">
                  <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center">
                    <img src="/api/placeholder/40/40" alt="Clock" className="w-10 h-10" />
                  </div>
                </div>
                <div>
              ...
              <div className="bg-purple-100 rounded-lg p-6 flex">
                <div className="mr-4">
                  <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center">
                    <img src="/api/placeholder/40/40" alt="Seat" className="w-10 h-10" />
                  </div>
                </div>
                <div>
              ...
              <div className="bg-purple-100 rounded-lg p-6 flex">
                <div className="mr-4">
                  <div className="w-16 h-16 bg-black rounded-full flex items-center justify-center">
                    <img src="/api/placeholder/40/40" alt="Check" className="w-10 h-10" />
                  </div>
                </div>
                <div>
      ...
      <section className="py-12 px-4">
        <div className="max-w-6xl mx-auto">
          ...
          {/* Promo Cards - Updated layout with white box on purple background */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Promo Card 1 */}
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="relative h-48">
                <img src="/api/placeholder/400/200" alt="Jawa Tengah" className="w-full h-full object-cover" />
                ...
                <div className="absolute top-4 right-4">
                  <div className="bg-purple-500 w-8 h-8 flex items-center justify-center rounded-sm">
              ...
              <div className="p-4 flex justify-between items-center bg-purple-50">
                ...
                <div className="flex items-center">
                  <div className="bg-white px-12 py-1 rounded mr-2">
                    <span className="text-xs text-gray-600">GADOGADO</span>
                  </div>
                  <button className="bg-purple-500 text-white w-8 h-8 flex items-center justify-center rounded">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="relative h-48">
                <img src="/api/placeholder/400/200" alt="Road Trip" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <div className="relative h-48">
                <img src="/api/placeholder/400/200" alt="Malang-Surabaya" className="w-full h-full object-cover" />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                <div className="absolute bottom-4 left-4 text-white">
      ...
      <section className="py-12 px-4 bg-purple-50">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            {/* Previous Button */}
            <button className="absolute left-0 top-1/2 transform -translate-y-1/2 z-10 bg-white/70 w-10 h-10 rounded-full flex items-center justify-center shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow">
                <div className="h-48">
                  <img src="/api/placeholder/400/250" alt="Ketupat" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold mb-4">Me Time di Tengah Ketupat dan Perintilannya</h3>
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
                      <img src="/api/placeholder/40/40" alt="Stefanie" className="w-full h-full object-cover" />
                    </div>
                    <div>
                      <p className="text-sm font-medium">Stefanie Tirza</p>
                      <p className="text-xs text-gray-600">25 Apr 2025 • 3 Min Read</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow">
                <div className="h-48">
                  <img src="/api/placeholder/400/250" alt="Rantau" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold mb-4">Kembali ke Kota Rantau Bersama 'Rebecca'</h3>
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
                      <img src="/api/placeholder/40/40" alt="Pandu" className="w-full h-full object-cover" />
                    </div>
                    <div>
                      <p className="text-sm font-medium">Pandu Surya</p>
                      <p className="text-xs text-gray-600">26 Apr 2025 • 7 Min Read</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-lg overflow-hidden shadow">
                <div className="h-48">
                  <img src="/api/placeholder/400/250" alt="Kebersamaan" className="w-full h-full object-cover" />
                </div>
                <div className="p-4">
                  <h3 className="font-bold mb-4">Menjalin Kebersamaan Dengan Cara Liburan</h3>
                  <div className="flex items-center">
                    <div className="w-8 h-8 rounded-full overflow-hidden mr-2">
                      <img src="/api/placeholder/40/40" alt="Leonardo" className="w-full h-full object-cover" />
                    </div>
                    <div>
                      <p className="text-sm font-medium">Leonardo Firdausi</p>
                      <p className="text-xs text-gray-600">27 Apr 2025 • 5 Min Read</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {/* Next Button */}
            <button className="absolute right-0 top-1/2 transform -translate-y-1/2 z-10 bg-white/70 w-10 h-10 rounded-full flex items-center justify-center shadow">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
              </svg>
            </button>
